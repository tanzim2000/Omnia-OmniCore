...
Everything you receive arrives under **the Content Contract (TCC)**, the
agreement that makes a theme written by you work with a module written by
somebody else. It has one rule, and you are one half of it:

> The module describes **what it has**. You decide **how it looks**.

Colors, layout, animation, what to show and what to leave out: all yours.
The module's side of the bargain is that it never tries to make those
decisions for you. Your side is that you never assume what a module will
send.
